...
public class Pickable : MonoBehLogger {
    ...
    /// <summary>
    /// Переназначить «дом» предмета — точку и поворот, куда он вернётся при опускании.
    ///
    /// Нужно стопкам книг в главном меню: книгу кладут на вершину стопки, а не в ту
    /// дырку в её середине, откуда её взяли, — дырки там уже нет, стопка осела.
    /// </summary>
